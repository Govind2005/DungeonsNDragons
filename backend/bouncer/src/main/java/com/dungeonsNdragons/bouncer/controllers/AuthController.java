...
@Data public static class GoogleAuthRequest { private String idToken; }
...
@Data public static class AuthResponse {
    ...
    static AuthResponse success(String token, UUID id, String username, String email) {
        ...
        r.success = true; r.token = token; r.playerId = id; r.username = username; r.email = email;
        return r;
    }
    static AuthResponse error(String msg) {
        AuthResponse r = new AuthResponse(); r.success = false; r.error = msg; return r;
    }
}
}
