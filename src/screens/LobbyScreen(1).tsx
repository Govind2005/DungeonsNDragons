...
export function LobbyScreen({ players, onSelectCharacter, onStart, onLeave }: LobbyScreenProps) {
  ...
  const renderPlayerCard = (player: Player | undefined, slotIndex: number) => {
    ...
    // â”€â”€ Red-side characters face left (toward the VS divider) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div className="min-h-screen bg-[#04080f] relative overflow-hidden font-mono">
      ...
      {/* â”€â”€ BACKGROUND LAYER 1: Deep atmospheric gradient â”€â”€ */}
      <div className="absolute inset-0 pointer-events-none" style={{
        background: 'radial-gradient(ellipse 100% 60% at 50% 100%, rgba(10,20,50,0.95) 0%, rgba(4,8,15,1) 60%)',
      }} />

      {/* â”€â”€ BACKGROUND LAYER 2: Team color side bleeds â”€â”€ */}
      <div className="absolute inset-0 pointer-events-none" style={{
      ...
      {/* â”€â”€ BACKGROUND LAYER 3: Fine grid â”€â”€ */}
      <div className="absolute inset-0 pointer-events-none" style={{
      ...
      {/* â”€â”€ BACKGROUND LAYER 4: Diagonal lines â”€â”€ */}
      ...
      {/* â”€â”€ BACKGROUND LAYER 5: Center vertical divider glow â”€â”€ */}
      <div className="absolute inset-0 pointer-events-none" style={{
        background: 'radial-gradient(ellipse 4% 80% at 50% 50%, rgba(255,255,255,0.025) 0%, transparent 100%)',
      }} />

      {/* â”€â”€ BACKGROUND LAYER 6: Top accent line â”€â”€ */}
      ...
      {/* â”€â”€ BACKGROUND LAYER 7: Bottom floor line â”€â”€ */}
      ...
      {/* â”€â”€ BACKGROUND LAYER 8: Atmospheric top glow â”€â”€ */}
